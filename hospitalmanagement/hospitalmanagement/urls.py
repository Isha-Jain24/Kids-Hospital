...
urlpatterns = [
    ...
    path("singleblog", views.singleblog_view),
    path("doctordetail", views.doctordetail_view),
    path("services", views.services_view),
    path("servicedetail", views.servicedetail_view),
...
urlpatterns += [
    ...
    path('doctor-send-otp', views.doctor_send_otp, name='doctor-send-otp'),
    path('patient-send-otp', views.patient_send_otp, name='patient-send-otp'),
    path('verify-otp', views.verify_otp,name='verify_otp'),
]

# Developed By : nikesh kumar
